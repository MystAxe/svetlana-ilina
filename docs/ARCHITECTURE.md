...
Схема будущего конструктора историй описана в [`STORY_BUILDER_WORDPRESS.md`](./STORY_BUILDER_WORDPRESS.md). Истории сохраняют индивидуальную длину, но собираются из единого реестра проверяемых блоков.
