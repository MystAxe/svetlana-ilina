...
- `/istorii-peremen/oksana/` — история Оксаны после родов с голосовым сообщением, фотографиями, двумя видео и 12 смысловыми экранами.
...
- Подтверждённые фото и видео подключены к историям Полины, Светы, Вики и Оксаны; голосовое сообщение Оксаны опубликовано в OGG и MP3.
