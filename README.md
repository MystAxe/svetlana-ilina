...
- Фото и видео Полины подключены из согласованной выгрузки от 02.08.2026; точная цифра результата, рабочая цена, длительность наставничества, стаж и регалии по-прежнему явно помечены как требующие подтверждения.
...
- MU-plugin WordPress создаёт недостающие страницы, черновики статей и черновик истории Полины при первом входе администратора, но не изменяет уже существующие записи.
