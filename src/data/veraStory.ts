...
export const veraClips = {
  training: {
    ...
    description: 'Несколько моментов из тренировочного процесса с оригинальным звуком. Лицо скрыто.',
  ...
  scales: {
    ...
    description: 'Фрагмент взвешивания с оригинальным звуком. Стикер сохранён.',
