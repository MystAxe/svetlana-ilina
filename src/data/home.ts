...
export const testFeature = {
  ...
  duration: '≈ 3 минуты',
  title: 'Почему тело не меняется?',
  text: 'Ответьте на 10 коротких вопросов и получите персональный маршрут: что сейчас может мешать результату и с чего стоит начать.',
  action: { label: 'Пройти бесплатный тест', href: '/test/' },
  publicDisclaimer: 'Тест не ставит диагноз и не заменяет консультацию врача.',
  preview: {
    counter: 'Вопрос 1 из 10',
    question: 'С какой мыслью вы чаще всего остаётесь в последнее время?',
    options: ['Я вроде стараюсь, а вес стоит', 'После работы сил нет', 'Начинаю и снова бросаю'],
  },
};
...
export const formulaFeature = {
  ...
  price: '4 900 ₽',
  priceStatus: 'Стоимость по ТЗ · сентябрь 2026',
