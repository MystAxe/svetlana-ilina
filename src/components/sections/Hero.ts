...
interface HeroProps {
  ...
  outcome?: string; image?: EditorialImage; accentArt?: string;
}

export function Hero({ eyebrow, title, text, primaryAction, secondaryAction, outcome, image, accentArt }: HeroProps): string {
